    ...
    <GuestGuard>
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgb(249 197 197 / 0.20) 0%, transparent 70%)",
          }}
        />
        ...
        <div className="w-full max-w-sm relative">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-[#1a2332]">重置密码</h1>
            <p className="text-[#7a96ae] mt-1.5 text-sm">通过邮箱找回账号密码</p>
          </div>
